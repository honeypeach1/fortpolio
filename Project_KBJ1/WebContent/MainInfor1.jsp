...
<script>
    ...
    daum.postcode.load(function(data){
            ...
            oncomplete: function(data) {               
                /* 필요한 동작
                   1. 클릭한 주소를 get방식으로 부모창에 전송한다.
                   2. 전송받은 파라미터를 특정 아이디(주소값 구역)에 대입한다.
                   3. 현재 창은 종료가 된다.
                   
                   	해야할 동작
                   	1. 부모창의 주소값은 임의로 입력이 가능하지 않게 한다.(readonly)
                   	2. 부모창에 모든값들이 들어갈수 있게 자바스크립트를 구현한다. 예) alert('주소값을 입력하셔야 합니다.');
                   	
                 */
                 
                 var fullAdd = data.roadAddress; //도로명 주소 변수       
                 var extraAdd = '';				 //조합형 주소 변수
                 ...
                 if(data.buildingName !== '' && data.apartment ==='Y'){
                 	extraAdd += (extraAdd !== '' ? ',' + data.buildingNamw : data.building);
                 }
                 ...
                 //받아온 값을 부모창의 주소값에 대입하기
			

			document.getElementById("user_address").value = fullAdd;
          }  
        }).open();
    });
    }
...
<body onresize="parent.resizeTo(310,700)" onload="parent.resizeTo(310,680)">
<div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
                    <h2 class="titular">MENU BOX</h2>
                    <!-- 회원 기본 정보 변경란 -->&nbsp;
                    <form action="/Project_KBJ1/view/changeSubInfor" method="post" id="Myforms3">               
                    
                    <!-- 회원 세부 정보 초등학교 -->
                    <div class="input-container">
                        <input type="text" placeholder="Elementary school" class="email text-input" name="element_name">
                        <div class="input-icon envelope-icon-acount"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                    
                    <!-- 회원 세부 정보 중학교 -->
                    <div class="input-container">
                        <input type="text" placeholder="Middle school" class="password text-input" name="middle_name">
                        <div class="input-icon password-icon"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                    
                    <!-- 회원 세부 정보 고등학교 -->
                    <div class="input-container">
                        <input type="text" placeholder="High school" class="password text-input" name="high_name">
                        <div class="input-icon password-icon"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                    
                    <!-- 회원 세부 정보 대학교 -->
                    <div class="input-container">
                        <input type="text" placeholder="University" class="password text-input" name="univ_name">
                        <div class="input-icon password-icon"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                    
                    <!-- 회원 세부 정보 직업 -->
                    <div class="input-container">
                        <input type="text" placeholder="Job name" class="password text-input" name="job_name">
                        <div class="input-icon password-icon"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                    ...
                    <div class="input-container">
                    <section>
						<select style="position: relative;width: 260px; height: 50px; margin:0 0 20px 20px;padding-left: 45px; background: #50597b; color:white" name="marriage">
						<option value="null" disabled selected>Marriage</option>
                    ...
                    <!-- 회원 세부 정보 주소 -->
                    <div class="input-container">
                        <input type="text" placeholder="Address" class="password text-input" id="user_address" name="user_address" readonly="readonly">
                        <div class="input-icon password-icon"><span class="fontawesome-pencil scnd-font-color"></span></div>
                    </div>
                  <table align="center" style="margin-left: 65px"><tr><td>
                    <a class="sign-in button" href="#" onclick="return_execDaumPostcode();" style="width: 80px">주소</a>
                    </td><td><a class="sign-in button" href="#" onclick="document.getElementById('Myforms3').submit();" style="width: 80px">정보 변경</a>  
                  </td></tr></table>          
                    </form>
                    </div>
</body>
