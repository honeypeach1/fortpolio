...
<%
	...
	String NUM = session.getAttribute("USER_NUM").toString();
		...
		pw.print("<script>");
		pw.println("alert('허용되지 않은 접근입니다.');");
		pw.println("location.href='/Project_KBJ/Mainpage.jsp'");
		pw.println("</script>");
	}
		
	UserTable usertables = null;
	if(request.getAttribute("userProfile") != null){
		usertables = (UserTable)request.getAttribute("userProfile");
	}
	
	UserProfile userprof = null;
	if(request.getAttribute("userprofs") != null){
		userprof = (UserProfile)request.getAttribute("userprofs");
	}
...
<head>
  <meta charset="UTF-8">
  <title><%=usertables.getUser_name() %>의 마이페이지입니다.</title> 
</head>
<script type="text/javascript">
  	function delCk(){
	if (document.delForm.user_pw.value == false) {
...
<body>
	...
	<div class="main-container">
		...
		<ul class="header-menu horizontal-list">
			<li>
				<form action="/Project_KBJ1/view/InforPage" method="post" id="frms">
					<a class="header-menu-tab" href="#"
						onclick="document.getElementById('frms').submit();"><span
						class="icon fontawesome-home scnd-font-color"></span>Home</a>
				</form>
			</li>
		</ul>
		</header>
		...
		<div class="left-container container">
			...
			<div class="calendar-day block" style="height: 290px">
				<!-- CALENDAR DAY (RIGHT-CONTAINER) -->
				<div class="arrow-btn-container">
					<h2 class="titular"><%=Year%>년
						<%=Month+1%>월
					</h2>
				</div>
				<p class="the-day" style="font-size: 130px;"><%=Date%>일
				</p>
			</div>
			...
			<div class="menu-box block">
				...
				<h2 style="text-align: center;">메인 정보 변경</h2>
				<!-- 회원 기본 정보 변경 하기 위한 체크 값 -->
				&nbsp;
				<form action="/Project_KBJ1/view/checkInfor" method="post"
					id="Myforms">

					<!-- 회원 기본 정보 이름 -->
					<div class="input-container">
						<input type="text" placeholder="name" class="email text-input"
							name="user_name">
					...
					<div class="input-container">
						<input type="text" placeholder="Password"
							class="password text-input" name="user_pw">
					...
					<a class="sign-in button" href="#"
						onclick="document.getElementById('Myforms').submit();">Check!</a>
				</form>
				&nbsp; &nbsp;

				<h2 style="text-align: center;">세부 정보 변경</h2>
				<!-- 회원 세부 정보 변경 하기 위한 체크 값 -->
				&nbsp;
				<form action="/Project_KBJ1/view/checkInfor1" method="post"
					id="Myforms2">
					...
					<a class="sign-in button" href="#"
						onclick="document.getElementById('Myforms2').submit();">Check!</a>
				</form>
			</div>
		</div>
		...
		<div class="middle-container container">
			<!-- 가져오기 메인 정보 -->
			<div class="weather block clear" style="height: 410px">
				<h2 class="titular">
					<span class="fontawesome-user scnd-font-color"></span><strong>
						My Information</strong>
				</h2>
				<ul class="next-days">
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">name</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getUser_name() %></p>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Telephone</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getUser_tel() %></p>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Email Address</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getUser_email() %></p>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Born Date</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getBorn_date() %></p>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Gender</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getUser_gender() %></p>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Nation</span>
							</p>
							<p class="next-days-temperature"><%=usertables.getNation_name() %></p>
					</a></li>
				</ul>
			</div>

			<!-- 가져오기 세부 정보 -->
			<div class="weather block clear" style="height: 470px">
				<h2 class="titular">
					<span class="fontawesome-user scnd-font-color"></span><strong>
						Add Information</strong>
				</h2>
				<ul class="next-days">
					<li><a>
							<p class="next-days-date" style="text-align: center;">
								<span class="scnd-font-color">Element school</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature" style="text-align: center;"><%=userprof.getElement_school_name() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Middle school</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getMiddle_school_name() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">high school</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getHigh_school_name() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">University</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getUniversity_name() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">job_name</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getJob_name() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Home Address</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getPro_address() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li><a>
							<p class="next-days-date">
								<span class="scnd-font-color">Marriage</span>
							</p> <%if(userprof != null) {%>
							<p class="next-days-temperature"><%=userprof.getPro_marriage() %></p>
							<%}else{ %>
							<p class="next-days-temperature">정보가 없습니다.</p> <%} %>
					</a></li>
					<li>
						<%if(userprof == null){ %>
						<form action="/Project_KBJ1/view/subUpload" method="post"
							id="subUpload">
							<a class="fb-sign-in" href="#"
								style="text-align: center; margin-top: 0"
								onclick="document.getElementById('subUpload').submit();">
								<p>처음 세부 정보 등록!</p>
							</a>
						</form> <%} %>
					</li>
		...
		<div class="right-container container">
			<div class="profile block" style="height: 330px">

				<ul class="menu-box-menu">
					<h2 class="titular" style="background-color: #11a8ab">MAIN
						IMAGE</h2>
					<!-- 메인 이미지 -->
				...
				<div class="profile-picture big-profile-picture clear">
					<img width="160px" height="160px" alt="Anne Hathaway picture"
						src="/Project_KBJ1/User_Image/<%=usertables.getUser_image()%>">
				</div>
				<form action="/Project_KBJ1/view/MainimageUpload" method="post"
					enctype="multipart/form-data">
					<a class="fb-sign-in" href="#" style="text-align: center;"> <input
						type="file" name="image_file"> <input type="submit"
						value="전송">
					</a>
				</form>
			</div>
			...
			<div class="profile block" style="height: 330px">
				...
				<ul class="menu-box-menu">
					<h2 class="titular" style="background-color: #11a8ab">ADD
						IMAGE</h2>
					<!-- 메인 이미지 -->
					<a class="add-button" href="#"></a>
				</ul>
				...
				<div class="profile-picture big-profile-picture clear"
					...
					<%if(userprof != null){ %>
					<img width="160px" height="160px" alt="이미지를 업로드 하세요!"
						src="/Project_KBJ1/sub_Image/<%=userprof.getPro_image1()%>">
					<%}else{ %>
					<img width="160px" height="160px" alt="이미지를 등록하세요" src="">
					<%} %>
				</div>
				<form action="/Project_KBJ1/view/imageUpload1" method="post"
					enctype="multipart/form-data">
					<a class="fb-sign-in" href="#" style="text-align: center;"> <input
						type="file" name="image_file"> <input color:
						white" type="submit" value="전송">
					</a>
				</form>
			</div>

			<div class="menu-box block" style="height: 280px">
				<h2 class="titular">Withdrawal</h2>
				<h2 style="text-align: center;">회원 탈퇴 하기</h2>
				<!-- 회원 기본 정보 변경 하기 위한 체크 값 -->
				&nbsp;
				<form action="/Project_KBJ1/view/deleteRegist" method="post"
					name="delForm" id="deleteform" onsubmit="return delCk();">
					...
					<input class="sign-in button" type="submit" value="회원 탈퇴">
				</form>
			</div>
		</div>
		<!-- end right-container -->
