...
<%@page import="model.CommentTable"%>
  ...
  <div class="row">
    ...
    <div class="col-md-6 order-3 order-md-2">
      <div class="card shadow mb-3">
					<div class="card-body">
					<!-- 등록 버튼 -->
						<form action="/Project_KBJ1/view/registTimeLine1" method="post" 
      						  enctype="multipart/form-data" name="fr" onsubmit="return UploadLine()">
	  ...
	  <div class="card shadow mb-3">
        ...
        <div class="d-flex">
            ...
            <div class="flex-grow-1">
              ...
              <small class="text-muted"> #기분 ${dtos.getCondition_name()}</small></h5>
		...
		<c:if test="${dtos.getUser_num() eq sessionScope.USER_NUM}">			
			<form action="/Project_KBJ1/view/deleteLine" method="get">
			...
			<td style="width: 90%">
			<!-- /TODO 댓글 폼 -->
            <form action="/Project_KBJ1/view/comments" method="get" style="float: left; width: 100%">
		...
		<table>
            ...
            <form action="/Project_KBJ1/view/DeleteComm" method="get">
