...
<body style="background-color: #666666;">
	...
	<div class="limiter">
		...
		<div class="wrap-login100">
				<form action="/project_mvc22/view/LoginLeave" class="login100-form validate-form" method="post">
					...
					<div class="flex-sb-m w-full p-t-3 p-b-32">
						...
						<button class="login100-form-btn" style="width: 450px;" name="leave_people" type="submit">
							Leave people sign up
						</button>
						</div>
					</form>
					<div class="login100-more" style="background-image: url('/project_mvc22/sign_leave/images/leave.jpg');">
				</div>
			</div>
		</div>
	</div>
