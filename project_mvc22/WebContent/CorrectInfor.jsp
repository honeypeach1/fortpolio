...
<div class="w3-half4 w3-red w3-container w3-center w3-round" style="height:700px; width:80%; background-image">
    <div class="w3-padding-64 w3-padding-large w3-center w3-round" style="height:600px; width:100%;">
      <h1> 추가 정보를 수정합니다. </h1>
      <form action="/project_mvc22/view/CorrectInfor" method="get" class="w3-container w3-card w3-padding-32 w3-white w3-round" style="height:500px; width:100%;">
        ...
        <button type="submit" class="w3-button w3-black w3-center w3-large w3-round" style="width:50%">추가 정보 수정하기</button>
      </div>
      </form>
    </div>
  </div>
